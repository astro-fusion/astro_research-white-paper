...
latex_documents = [
    (
        root_doc,
        "VedicNumerologyAstrology.tex",
        "Vedic Numerology-Astrology Integration System Documentation",
        "Bishal Ghimire",
        "manual",
    ),
]
...
texinfo_documents = [
    (
        ...
        author,
        "VedicNumerologyAstrology",
        "Computational integration of Vedic numerology with sidereal astrology.",
        "Miscellaneous",
    ),
]
