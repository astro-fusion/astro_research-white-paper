...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, titlerule=0mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, bottomtitle=1mm, arc=.35mm, breakable, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
