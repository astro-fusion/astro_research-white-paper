...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, opacityback=0, toptitle=1mm, arc=.35mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
