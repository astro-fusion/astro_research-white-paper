...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, titlerule=0mm, leftrule=.75mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, colback=white, opacitybacktitle=0.6]
