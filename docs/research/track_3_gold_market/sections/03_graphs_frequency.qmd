...
while root and not (root / "pyproject.toml").exists():
    root = root.parent
data_dir = (root or Path.cwd()) / "research" / "use_cases" / "gold_market" / "data"

metrics_path = data_dir / "gold_astro_metrics.csv"
if not metrics_path.exists():
    gen_features = (root or Path.cwd()) / "research" / "use_cases" / "gold_market" / "scripts" / "generate_gold_astro_features.py"
    gen_catalog = (root or Path.cwd()) / "research" / "use_cases" / "gold_market" / "scripts" / "generate_gold_astro_catalog.py"
    gen_metrics = (root or Path.cwd()) / "research" / "use_cases" / "gold_market" / "scripts" / "compute_gold_astro_metrics.py"
