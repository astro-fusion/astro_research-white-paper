...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, titlerule=0mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm]
