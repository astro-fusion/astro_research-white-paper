...
principles of ``Severe Testing'' (Mayo and Spanos 2006)---establishing
...
\tightlist
\item
  \textbf{Granger Causality} (Granger 1969): Testing whether past values
  of one variable improve predictions of another
\item
  \textbf{Lomb-Scargle Spectral Analysis} (Lomb 1976): Detecting
  periodic signals in unevenly sampled data
\item
  \textbf{Unit Root Tests} (Dickey and Fuller 1979): Ensuring
...
\includegraphics[width=1\textwidth,height=\textheight]{../../research/reports/artifacts/fig_multi_planet_cycles.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{../../research/reports/artifacts/fig_mars_variation.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{../../research/reports/artifacts/fig_permutation_dist.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{../../research/reports/artifacts/fig_periodogram.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{../../research/reports/artifacts/fig_molchan.pdf}
...
AG, Astrodienst. 2023. {``Swiss Ephemeris: High Precision Planetary
Ephemeris DE440.''} \url{https://www.astro.com/swisseph/}.
...
American Statistical Association} 74 (366): 427--31.
...
424--38. \url{https://doi.org/10.2307/1912791}.

\bibitem[\citeproctext]{ref-knuth_literate}
Knuth, Donald E. 1984. \emph{Literate Programming}. \emph{The Computer
Journal}. Vol. 27. 2. \url{https://doi.org/10.1093/comjnl/27.2.97}.
...
Spaced Data.''} \emph{Astrophysics and Space Science} 39: 447--62.
\url{https://doi.org/10.1007/BF00648343}.

\bibitem[\citeproctext]{ref-mayo_severe_testing}
Mayo, Deborah G., and Aris Spanos. 2006. {``Severe Testing as a Basic
Concept in a Neyman--Pearson Philosophy of Induction.''} \emph{The
British Journal for the Philosophy of Science} 57 (2): 323--57.
...
Yahoo Finance. 2024. {``XAU/USD Historical Data.''}
...
\ExtensionTok{python3}\NormalTok{ research/scripts/generate\_artifacts.py}
