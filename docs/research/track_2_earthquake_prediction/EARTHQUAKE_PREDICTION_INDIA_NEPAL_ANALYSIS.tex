...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, left=2mm, arc=.35mm, rightrule=.15mm, colback=white, opacityback=0, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, opacitybacktitle=0.6, breakable, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, titlerule=0mm]
