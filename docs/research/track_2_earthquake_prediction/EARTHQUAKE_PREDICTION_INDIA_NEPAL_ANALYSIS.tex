...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, left=2mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
