# Results: Hypothesis Testing (Combination Frequencies)

## 13.1 Observed vs. Expected Frequencies

To test the hypothesis that specific planetary combinations occur more frequently during seismic windows, we calculated the **Activation Frequency** for every combination in our catalog.
...
plt.title("Observed Frequency by Category (2015-2024)")
