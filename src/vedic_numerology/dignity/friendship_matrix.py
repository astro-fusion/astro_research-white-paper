...
def calculate_tatkalika_maitri(chart: 'BirthChart', planet1: Planet, planet2: Planet) -> FriendshipType:
    """
    ...
    if not hasattr(chart, 'planets') or planet1.name not in chart.planets or planet2.name not in chart.planets:
        return FriendshipType.NATURAL_NEUTRAL
    ...
    friendly_houses = {1, 2, 3, 9, 10, 11}  # 2, 3, 4, 10, 11, 12 from planet1 (0-indexed)
...
def are_planets_friends(planet1: Planet, planet2: Planet, chart: Optional['BirthChart'] = None) -> bool:
    """
...
def get_friendship_description(planet1: Planet, planet2: Planet, chart: Optional['BirthChart'] = None) -> str:
    """
...
def get_planet_friends(planet: Planet, chart: Optional['BirthChart'] = None) -> List[Planet]:
    """
