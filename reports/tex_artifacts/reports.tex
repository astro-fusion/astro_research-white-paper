...
\setstretch{1.2}
\mainmatter
Welcome to our research findings. Here we document our empirical
investigations into astrological and numerological systems.
...
\endlastfoot
\textbf{Numerology} &
\href{use_cases/numerology/research_paper/numerology_astrology_correlation.qmd}{Temporal
Discontinuity: A Quantitative Analysis} & ✅ Published \\
\textbf{Earthquake} & \href{use_cases/earthquake/report.qmd}{Seismic
Activity \& Planetary Correlations} & 🚧 In Progress \\
\end{longtable}

\chapter{Upcoming Research}\label{upcoming-research}

We are currently expanding our dataset to include: - Historical stock
market crash cycles - Celebrity career path analysis - Global weather
