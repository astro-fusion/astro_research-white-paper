...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, coltitle=black, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacityback=0, arc=.35mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm, breakable, rightrule=.15mm, leftrule=.75mm]
