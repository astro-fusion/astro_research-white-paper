...
def perform_sea_analysis(
    matrix_path: str = "regression_matrix.csv", output_dir: str = "sea_plots"
):
    """
    ...
    threshold_mag = 5.0
    epochs = (
        df[df["max_magnitude"] >= threshold_mag]
        .sort_values("max_magnitude", ascending=False)
        .head(100)
    )
