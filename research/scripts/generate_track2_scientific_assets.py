...
def generate_track2_assets(
    ...
    try:
        ...
        with open(
            "docs/research/track_2_earthquake_prediction/india_nepal_data.json", "w"
        ) as f:
    ...
    plt.plot(
        ...
        color="purple",
        alpha=0.5,
        label="Planetary Stress Index (Model)",
    )
    ...
    plt.title(
        "Phase 2: Pattern Matching (Planetary Stress vs. Major Quakes)", fontsize=14
    )
    ...
    plt.title(
        "Phase 3: Validation (Correlation Check)\nStress Index vs. Magnitude",
        fontsize=14,
    )
