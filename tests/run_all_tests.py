...
class MasterTestRunner:
    ...
    def run_unit_tests(self):
        ...
        try:
            ...
            return {"status": "error", "error": str(e), "tests": 0, "passed": 0, "failed": 0}
    ...
    def run_e2e_tests(self):
        ...
        try:
            ...
            if "Playwright not installed" in output:
                ...
                return {"status": "skipped", "reason": "playwright_not_installed", "tests": 0, "passed": 0, "failed": 0}
            ...
            if "Connection refused" in output or "refused" in output.lower():
                ...
                return {"status": "skipped", "reason": "app_not_running", "tests": 0, "passed": 0, "failed": 0}
