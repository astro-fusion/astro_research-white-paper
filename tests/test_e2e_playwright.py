...
class AstroResearchE2ETester:
    ...
    async def test_api_endpoint_health(self):
        ...
        try:
            ...
            if response and response.status == 200:
                ...
                print(f"⚠️  Health endpoint not available (status: {response.status if response else 'N/A'})")
    ...
    async def test_javascript_execution(self):
        ...
        try:
            ...
            print(f"✅ JS Execution - Headings: {result['headings']}, Body Height: {result['bodySize']}px")
            self._record_test(test_name, True)
            return True
        except Exception as e:
            print(f"❌ Error: {e}")
    ...
    async def test_content_rendering(self):
        ...
        try:
            ...
            print(f"✅ Content rendering - Text: {len(body_text)} chars, Images: {images}")
            self._record_test(test_name, True)
            return True
        except Exception as e:
            print(f"❌ Error: {e}")
    ...
    async def test_form_interaction(self):
        ...
        try:
            ...
            print(f"✅ Forms found - Forms: {form_count}, Inputs: {input_count}, Buttons: {button_count}")
            self._record_test(test_name, True)
            return True
        except Exception as e:
            print(f"⚠️  Error: {e}")
    ...
    async def test_performance_metrics(self):
        ...
        try:
            ...
            print(f"✅ Performance - Load: {load_time:.2f}s, Resources: {metrics['resourceCount']}")
            self._record_test(test_name, True)
            return True
        except Exception as e:
            print(f"⚠️  Error: {e}")
    ...
    async def test_accessibility(self):
        ...
        try:
            ...
            print(f"✅ Accessibility - Headings: {accessibility['headings']}, Alt text: {accessibility['images']}")
            self._record_test(test_name, True)
            return True
        except Exception as e:
            print(f"⚠️  Error: {e}")
    ...
    def _print_summary(self):
        """Print test summary."""
        percentage = (self.results["passed"] / self.results["total"] * 100) if self.results["total"] > 0 else 0
